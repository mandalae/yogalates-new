...
function App() {
  ...
  const getLoginLogoutButton = (user) => {
      ...
      return (
          <Dropdown className="ml-4">
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Divider />
              <Dropdown.Item href="#/action-5" onClick={signOut}>
        ...
        return <NavLink className="btn btn-secondary ml-2" to="/admin">Log ind</NavLink>;
    }
  };
